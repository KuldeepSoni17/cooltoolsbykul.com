      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-zinc-700 bg-zinc-900/70 p-4">
          ...
          <button
            ...
            onClick={() => gameSocket.emit("queue:joinSoloBots", payload)}
          >
            Play now
          </button>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-700 bg-zinc-900/70 p-4">
          ...
          <button className="mt-4 h-11 w-full rounded-lg bg-indigo-500 font-semibold" onClick={() => gameSocket.emit("queue:joinPublic", payload)}>
            Join queue
          </button>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-700 bg-zinc-900/70 p-4">
          ...
          <button className="mt-2 h-10 w-full rounded-lg bg-cyan-600 font-semibold" onClick={() => gameSocket.emit("lobby:create", payload)}>
            Create lobby
          </button>
          ...
          <button
            ...
            onClick={() => gameSocket.emit("lobby:join", { ...payload, lobbyId: joinLobbyId.trim() })}
          >
            Join lobby
          </button>
        </div>
